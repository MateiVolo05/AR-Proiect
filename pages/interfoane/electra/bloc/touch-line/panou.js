import {useColorModeValue, Heading, Center, Box, Text, List, ListItem, ListIcon, useColorMode, HStack, Button, VStack } from "@chakra-ui/react";
...
export default function Panou(){
    ...
    return (
        <Nav title="Smart Panou Video- Blocuri">
            <Center><Heading fontSize={["xl",, "5xl"]} bgGradient={`linear(to-br, ${color1}, ${color2})`} bgClip="text">Smart Panou Video- Blocuri</Heading></Center>
            <HStack pt={24} pl={8} pr={8} justifyContent="center">
                ...
                <Box alignSelf="flex-end" pb={16} pl={4}>
                    <VStack>
                        <HStack>
                            <Button bg={color2} color={revcolormode} onClick={handleClickWhite}>Alb</Button>
                            <Button bg={color2} color={revcolormode} onClick={handleClickBlack}>Negru</Button>
                        </HStack>
                        <HStack>
                            <Button bg={color2} color={revcolormode} onClick={handleClickIncastrat}>Incastrat</Button>
                            <Button bg={color2} color={revcolormode} onClick={handleClickAparent}>Aparent</Button>
                        </HStack>
                    </VStack>
                </Box>
            </HStack>
