...
import smart from "../../../../../public/smart7.png"
import smartBg from "../../../../../public/smart7-bg.png"
import smartAlb from "../../../../../public/smart7Alb.png"
import smartAlbBg from "../../../../../public/smart7Alb-bg.png"
...
export default function Panou(){
    ...
    return (
        <Layout title='SMART+ TERMINAL VIDEO 7"'>
            <Box className="product">
                <Center><Heading textAlign="center" fontSize={["xl",, "5xl"]} bgGradient={`linear(to-br, ${color1}, ${color2})`} bgClip="text">SMART+ TERMINAL VIDEO 7{'"'}</Heading></Center>
                <HStack pt={24} pl={8} pr={8} justifyContent="center">
                    <Box>
                        {
                            colorMode==='light' && color==='black' ?
                                <Image src={smart} alt='SMART+ TERMINAL VIDEO 7"' width="500vh" height="600vh" /> : ''
                        }
                        {
                            colorMode==='dark' && color==='black' ?
                                <Image src={smartBg} alt='SMART+ TERMINAL VIDEO 7"' width="500vh" height="600vh" /> : ''
                        }
                        {
                            colorMode==='light' && color==='white' ?
                                <Image src={smartAlbBg} alt='SMART+ TERMINAL VIDEO 7"' width="500vh" height="600vh" /> : ''
                        }
                        {
                            colorMode==='dark' && color==='white'?
                                <Image src={smartAlb} alt='SMART+ TERMINAL VIDEO 7"' width="500vh" height="600vh" /> : ''
                        }
                    </Box>
                ...
                <Box pl={4} pt={8} color={colormode}>
                    ...
                    <Box pl={4} pt={4} pr={4} fontSize={["md",, "xl"]} textAlign="justify">
                        ...
                        <Text>Prin aspectul compact si esentializat, terminalul video de 7” smart+ este o prezenta cu stil, ce se integreaza natural in orice ambianta interioara.</Text>
                    </Box>
                </Box>
                <Box pl={4} pt={8} color={colormode}>
                    <Heading fontSize={["lg",, "3xl"]}>Asamblare inteligenta | Instalare usoara</Heading>
                    <Box pl={4} pt={4} pr={4} fontSize={["md",, "xl"]} textAlign="justify">
                        <Text>Solutia ELECTRA de asamblare a terminalului video de 7” smart+ este originala si eficienta, avand ca efect atat aspectul suplu al produsului, cat si protectia la praf si usurinta de instalare.</Text>
                ...
                <Box pl={4} pt={8} color={colormode}>
                    ...
                    <Box pl={4} pt={4} pr={4} fontSize={["md",, "xl"]}>
                        <Text>Terminalul video de 7” smart+ poate realiza mai multe functii in interiorul locuintei, deoarece ofera posibilitatea conectarii directe a unor dispozitive aditionale:</Text>
                        <br />
                        <List>
                            <ListItem pb={2}>
