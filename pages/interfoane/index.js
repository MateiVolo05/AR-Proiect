    ...
    return(
        <Nav title="Interfoane">
            ...
            <Stack direction={["column",, 'row']} justifyContent={["center",, "space-between"]} pt={16} pr={[4,, 0]}>
                <Box color={colormode} borderRightStyle="solid" borderTopStyle="solid" borderBottomStyle={["solid",,"none"]}  borderLeftStyle={["solid",,"none"]}  borderColor={color1} borderWidth={[2,,3]} pr="15vh" borderRadius={["15px",, "0 15px 0 0"]} ml={[,, -4]} w={["100%",,"50%"]}>
